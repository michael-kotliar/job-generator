...
GIT_VERSION_FILE = path.join('job_generator', '.git_version')
...
setup(
    name='job-generator',
    description="Miraldi Lab Workflow Job Generator",
    long_description=open(path.join(path.dirname(__file__), 'README.md')).read(),
    long_description_content_type="text/markdown",
    version=get_version(),
    url='https://github.com/MiraldiLab/job-generator',
    download_url='https://github.com/MiraldiLab/job-generator',
